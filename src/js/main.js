...
async function loadContent() {
  try {
    // GÜNCELLEME 1: Netlify'da çalışması için '/src/data/' yerine '/data/' yapıldı.
...
function renderPage(data) {
  ...
  // GÜNCELLEME 2: Whatsapp mesajı parametre olarak gönderiliyor.
...
// GÜNCELLEME 3: waMessage parametresi eklendi ve link yapısı güncellendi.
function addFloatingButtons(waNumber, igLink, waMessage) {
  ...
  // Mesaj varsa encode edip linke ekle, yoksa boş bırak
