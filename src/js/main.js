...
window.changeLanguage = function(lang) {
  ...
  if (lang === 'en') {
    ...
    updateElement('nav-reviews', 'Reviews'); // YENİ
    updateElement('nav-about', 'About Us');  // YENİ
    updateElement('nav-contact', 'Contact');
    
    updateElement('hero-contact-text', 'Contact Us');
    updateElement('about-badge', 'Expert Staff'); // YENİ
    ...
    updateElement('nav-reviews', 'Отзывы'); // YENİ
    updateElement('nav-about', 'О нас');    // YENİ
    updateElement('nav-contact', 'Контакты');

    updateElement('hero-contact-text', 'Связаться с нами');
    updateElement('about-badge', 'Экспертный персонал'); // YENİ
    ...
    updateElement('nav-reviews', 'Yorumlar'); // YENİ
    updateElement('nav-about', 'Hakkımızda'); // YENİ
    updateElement('nav-contact', 'İletişim');

    updateElement('hero-contact-text', 'Bize Ulaşın');
    updateElement('about-badge', 'Uzman Kadro'); // YENİ
...
function renderPage(data) {
  ...
  // 6. YENİ: Hakkımızda (Hekim) Bölümü
  if (data.about) {
